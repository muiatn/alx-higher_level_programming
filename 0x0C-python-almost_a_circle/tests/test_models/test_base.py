...
OBOBOB
    def test_to_json_string_square_type(self):
        s = Square(10, 2, 3, 4)
OBOBOB        self.assertEqual(str, type(Base.to_json_string([s.to_dictionary()])))
...
OAOAOA
OAOAOA    def test_to_json_string_none(self):
        self.assertEqual("[]", Base.to_json_string(None))

    def test_to_json_string_no_args(self):
OAOAOA        with self.assertRaises(TypeError):
            Base.to_json_string()
...
OBOBOB    def test_save_to_file_one_rectangle(self):
